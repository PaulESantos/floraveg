...
This outlines how to propose a change to floraveg. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PaulESantos/floraveg", fork = TRUE)`.
...
Please note that the floraveg project is released with a [Contributor
Code of
Conduct](https://paulesantos.github.io/floraveg/CODE_OF_CONDUCT.md). By
