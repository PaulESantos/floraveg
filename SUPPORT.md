...
Thanks for using floraveg! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/PaulESantos/floraveg/issues/new).
...
requests](https://github.com/PaulESantos/floraveg/issues) to make sure
